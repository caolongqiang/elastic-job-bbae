...
public final class CloudJobFacade implements JobFacade {
    ...
    @Override
    public void postJobStatusTraceEvent(final String taskId, final State state, final String message, String nameSpace) {
        TaskContext taskContext = TaskContext.from(taskId);
        jobEventBus.post(new JobStatusTraceEvent(taskContext.getMetaInfo().getJobName(), shardingContexts.getNameSpace(), taskContext.getId(), taskContext.getSlaveId(),
